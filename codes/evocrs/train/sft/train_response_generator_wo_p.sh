...
BASE_OUTPUT_DIR="${SUPPLEMENTARY_ROOT}/checkpoints/response_generator/without_persona/qwen2.5-7b-instruct"
...
DATA_DIR="${SUPPLEMENTARY_ROOT}/data/evocrs/response_generator/target_response/without_persona"
...
WANDB_RUN_NAME="response_generator_wo_p_qwen25_7b-$(date "+%Y%m%d-%H%M")"
...
{
    echo "=========================================================="
    echo "Starting Response Generator Training (without persona)..."
