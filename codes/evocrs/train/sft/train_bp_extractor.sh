...
BASE_OUTPUT_DIR="${SUPPLEMENTARY_ROOT}/checkpoints/persona_processor/behavioral_persona_extract/qwen2.5-7b-instruct"
...
TRAIN_DATA="${SUPPLEMENTARY_ROOT}/data/evocrs/persona_processor/behavioral_persona_extract/behavioral_persona_extract_train.json"
VAL_DATA="${SUPPLEMENTARY_ROOT}/data/evocrs/persona_processor/behavioral_persona_extract/behavioral_persona_extract_val.json"

WANDB_API_KEY="__WANDB_API_KEY__"

WANDB_RUN_NAME="BP-Run-$(date "+%Y%m%d-%H%M")"
...
deepspeed --include localhost:6,7 --master_port=$MASTER_PORT train.py \
