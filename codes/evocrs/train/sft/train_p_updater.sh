...
BASE_OUTPUT_DIR="${SUPPLEMENTARY_ROOT}/checkpoints/persona_processor/persona_update/qwen2.5-7b-instruct"
...
TRAIN_DATA="${SUPPLEMENTARY_ROOT}/data/evocrs/persona_processor/persona_update/persona_update_train.json"
VAL_DATA="${SUPPLEMENTARY_ROOT}/data/evocrs/persona_processor/persona_update/persona_update_val.json"

WANDB_API_KEY="__WANDB_API_KEY__"

WANDB_RUN_NAME="Updater-Run-$(date "+%Y%m%d-%H%M")"
...
deepspeed --include localhost:2,3 --master_port=$MASTER_PORT train.py \
